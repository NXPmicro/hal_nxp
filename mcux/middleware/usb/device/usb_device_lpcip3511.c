...
#define CONTROL_TRANSFER_DATA_OFFSET (0u)
#define ZERO_TRANSFER_DATA_OFFSET ((USB_DATA_ALIGN_SIZE_MULTIPLE(64U) >> 2))
#define RESERVED_EP_DATA_OFFSET ((USB_DATA_ALIGN_SIZE_MULTIPLE(64U) >> 2) + (USB_DATA_ALIGN_SIZE_MULTIPLE(4) >> 2))
#else
#define SETUP_TRANSFER_DATA_OFFSET (0U)
